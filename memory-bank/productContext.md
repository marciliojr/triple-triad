...
Teclas da UI: **Z** seleciona, **X**/Del remove (álbum com confirmação; pick só a mão), **C** amplia, **R** aleatório no construtor/picks, **Esc** volta. Na partida, **X** cancela a casa do tabuleiro.
